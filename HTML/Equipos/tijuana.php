...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=48";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=117";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=48";
...
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="VictorMendonza.jpg" width=150px><font face="Optima" size=4px color=black><p>Victor Mendonza</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="JonathanManolas.jpg" width=150px><font face="Optima" size=4px color=black><p>Jonathan Manolas</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="EduardoMendez.jpg"width=150px><font face="Optima" size=4px color=black><p>Eduardo Mendez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="GilEsaulAlcala.png" width=150px><font face="Optima" size=4px color=black><p>Gil Esaul Alcala</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="BrayanDiaz.jpg" width=150px><font face="Optima" size=4px color=black><p>Brayan Diaz</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MarcelAlejandro.jpg" width=150px><font face="Optima" size=4px color=black><p>Marcel Alejandro Ruiz</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="ErycLeonelCastillo.png" width=150px><font face="Optima" size=4px color=black><p>Eryc Leonel Castillo</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="SebastianYañez.png"width=150px><font face="Optima" size=4px color=black><p>Sebastian Yañez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="ChristianHernando.png" width=150px><font face="Optima" size=4px color=black><p>Christian Hernando</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="DanielValdez.jpg" width=150px><font face="Optima" size=4px color=black><p>Daniel Valdez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MauroAndresPeas.jpg" width=150px><font face="Optima" size=4px color=black><p>Mauro Andrés Peas</p></font></div></td></tr>
