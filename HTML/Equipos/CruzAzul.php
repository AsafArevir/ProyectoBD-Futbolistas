...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=36";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=105";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=36";
...
<body>
 ...
 <table border=5 width=300px align="center">
	...
	<tbody>	
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Jesus2.jpg" width=150px><font face="Optima" size=4px color=black><p>Jose de Jesus Corona</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Alexis12.jpg" width=130px><font face="Optima" size=4px color=black><p>Alexis Pena</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Joaquin2.png" width=180px><font face="Optima" size=4px color=black><p>Joaquin Martinez</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Pablo2.jpg" width=180px><font face="Optima" size=4px color=black><p>Pablo Aguilar</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Juan2.jpg" width=180px><font face="Optima" size=4px color=black><p>Juan Escobar</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Ignacio2.jpg" width=180px><font face="Optima" size=4px color=black><p>Ignacio Rivero</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Alexis2.jpg" width=180px><font face="Optima" size=4px color=black><p>Alexis Gutierrez</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Rafael2.jpg" width=180px><font face="Optima" size=4px color=black><p>Rafael Baca</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Guillermo2.jpg" width=180px><font face="Optima" size=4px color=black><p>Guillermo Fernadez</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Walter2.jpg" width=150px ><font face="Optima" size=4px color=black><p>Walter Montoya</p></font></div></td></tr>
			<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Lucas2.jpg" width=150px ><font face="Optima" size=4px color=black><p>Lucas Passerini</p></font></div></td></tr>
