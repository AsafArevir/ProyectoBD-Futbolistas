...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=38";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=107";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=38";
...
<center><h1><font color=white>Fotos</font></h1></center>
 <table border=5 width=300px align="center">
	...
	<tbody>	
		...
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Daniel3.jpg" width=150px><font face="Optima" size=4px color=black><p>Daniel Gutierrezz</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Nicolas3jpg.jpg" width=150px><font face="Optima" size=4px color=black><p>Nicolas Vikonis</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Ygor3.jpg" width=130px><font face="Optima" size=4px color=black><p>Ygor Nogueira</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Nestor3.jpg" width=180px><font face="Optima" size=4px color=black><p>Nestor Vidrio</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="NicolasD3.jpg" width=180px><font face="Optima" size=4px color=black><p>Nicolas Diaz</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Roberto3.jpg" width=180px><font face="Optima" size=4px color=black><p>Roberto Meraz</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Gonzalo3.jpg" width=180px><font face="Optima" size=4px color=black><p>Gonzalo Freitas</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Giovanni.jpg" width=180px><font face="Optima" size=4px color=black><p>Giovanni Augusto</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Daniel3.jpg" width=180px><font face="Optima" size=4px color=black><p>Daniel Amador</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Michel3.jpg" width=150px ><font face="Optima" size=4px color=black><p>Michel Rangel</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Brian3.jpg" width=150px ><font face="Optima" size=4px color=black><p>Brian Rubio</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Sagir3.jpg" width=150px ><font face="Optima" size=4px color=black><p>Sagir Arce</p></font></div></td></tr>
