...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=47";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=116";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=47";
...
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="WashingtonAguerre.jpg" width=150px><font face="Optima" size=4px color=black><p>Washington Aguerre</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="GerardoRuiz.jpg" width=150px><font face="Optima" size=4px color=black><p>Gerardo Ruiz </p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="JuanJuearez.jpg" width=150px><font face="Optima" size=4px color=black><p>Juan Juearez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MaximilianoPerg.png" width=150px><font face="Optima" size=4px color=black><p>Maximiliano Perg</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="AlexisDoldan.jpg" width=150px><font face="Optima" size=4px color=black><p>Alexis Doldan</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="BetsielHernandez.png" width=150px><font face="Optima" size=4px color=black><p>Betsiel Hernandez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="OmarMendoza.jpg" width=150px><font face="Optima" size=4px color=black><p>Omar Mendoza</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="OsvaldoMartinez.jpg" width=150px><font face="Optima" size=4px color=black><p>Osvaldo Martinez</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="BryanOlivera.jpg" width=150px><font face="Optima" size=4px color=black><p>Bryan Olivera</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="RaulTorres.jpg" width=150px><font face="Optima" size=4px color=black><p>Raul Torres</p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="NicolasSosa.jpg" width=150px><font face="Optima" size=4px color=black><p>Nicolas Sosa</p></font></div></td></tr>
