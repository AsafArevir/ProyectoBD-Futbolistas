...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=33";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=102";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=33";
...
<center><h1><font color=white>Fotos</font></h1></center>
 <table border=5 width=300px align="center">
	...
	<tbody>	
		...
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Luis Garcia.jpg" width=150px><font face="Optima" size=4px color=black><p>Luis Garcia</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Haret Ortega.jpg" width=130px><font face="Optima" size=4px color=black><p>Haret Ortega</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Miguel Barbieri.jpg" width=180px><font face="Optima" size=4px color=black><p>Miguel Barbieri</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Diego Rigonato.jpg" width=180px><font face="Optima" size=4px color=black><p>Diego Rigonato</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Raul Lopez.jpg" width=180px><font face="Optima" size=4px color=black><p>Raul Lopez</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Claudio Baeza.jpg" width=180px><font face="Optima" size=4px color=black><p>Claudio Baeza</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Jose Juan Vazquez.jpg" width=180px><font face="Optima" size=4px color=black><p>Jose Juan Vazquez</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Alexis Canelo.jpg" width=180px><font face="Optima" size=4px color=black><p>Alexis Canelo</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Rubens Sambueza.png" width=180px><font face="Optima" size=4px color=black><p>Rubens Sambueza</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Braian Samudio.jpg" width=150px ><font face="Optima" size=4px color=black><p>Braian Samudio</p></font></div></td></tr>
		<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="Ian Gonzalez.jpg" width=150px ><font face="Optima" size=4px color=black><p>Ian Gonzalez</p></font></div></td></tr>
