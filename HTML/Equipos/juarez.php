...
$sql = "SELECT NOMBRE, APELLIDO, NO_CAMISETA, POSICION, APODO FROM JUGADOR WHERE ID_EQUIPO=46";
...
$sql1 = "SELECT * FROM DIRECTOR WHERE id_director=115";
...
$sql2 = "SELECT * FROM  auxiliar WHERE ID_EQUIPO=46";
...
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="HugoGonzales.png"width=150px><font face="Optima" size=4px color=black>Hugo Gonzalez<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="GustavoVelazquez.jpeg"width=150px><font face="Optima" size=4px color=black>Gustavo Velazquez<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="AdrianMora.jpg" width=150px><font face="Optima" size=4px color=black>Adrian Mora<<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="HedgardoMarin.png" width=150px><font face="Optima" size=4px color=black>Pol Garcia<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="HedgardoMarin.png" width=150px><font face="Optima" size=4px color=black>Hedgardo Marin<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="AlonsoGracia.png" width=150px><font face="Optima" size=4px color=black>Alonso Gracia<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="JoseEsquivel.jpeg" width=150px><font face="Optima" size=4px color=black>Jose Esquivel<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MarcoFabian.jpg" width=150px><font face="Optima" size=4px color=black>Marco Fabian<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MatiasGracia.jpg" width=150px><font face="Optima" size=4px color=black>Matias Gracia<p></p></font></div></td></tr>
<tr><td width = "50%" bgcolor="ffffff"><div align="center"><img src="MartinGalvan.jpeg" width=150px><font face="Optima" size=4px color=black>Martin Galvan<p></p></font></div></td></tr>
