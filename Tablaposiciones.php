	...
	<button size=40px type="button" onclick="javascript:window.print()">Imprimir</button>
 	...
 	<thead>
		<tr>
			...
			<th width = "50%" bgcolor="#0A2257"><div align="center"><font face="Optima" size=5px color=white >PJ</font></div></th>
			<th width = "50%" bgcolor="#0A2257"><div align="center"><font face="Optima" size=5px color=white >PG</font></div></th>
			<th width = "50%" bgcolor="#0A2257"><div align="center"><font face="Optima" size=5px color=white >PP</font></div></th>
			<th width = "50%" bgcolor="#0A2257"><div align="center"><font face="Optima" size=5px color=white >Goles a Favor</font></div></th>
			<th width = "50%" bgcolor="#0A2257"><div align="center"><font face="Optima" size=5px color=white >Goles en Contra</font></div></th>
		</tr>
	</thead>
